...
# Whatever the desktop's own UI face is, then the ones almost every
# distribution ships, then Tk's fallback. There is no Segoe UI here and no
# single face that is always present the way there is on Windows: Adwaita
# Sans is current GNOME, Cantarell is older GNOME, Noto Sans is the Fedora
# and openSUSE default, and DejaVu Sans is the one that is on the machine
# even when nothing else is.
UI_STACK = ["Adwaita Sans", "Inter", "Cantarell", "Noto Sans", "Ubuntu",
            "Roboto", "Liberation Sans", "DejaVu Sans", "Helvetica"]
DISPLAY_STACK = ["Adwaita Sans", "Inter", "Cantarell", "Noto Sans",
                 "Ubuntu", "Roboto", "Liberation Sans", "DejaVu Sans"]
MONO_STACK = ["JetBrainsMono Nerd Font", "JetBrains Mono", "Adwaita Mono",
              "Fira Code", "Hack", "Source Code Pro", "Noto Sans Mono",
